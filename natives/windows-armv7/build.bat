...
REM  o  nmake installed (comes e.g. with Visual Studio), call "vcvarsall.bat x64_arm" before to activate 64bit tools
REM
...
SET TARGET_CLASSES_PATH=%~dp0target\classes\lib\windows-armv7
