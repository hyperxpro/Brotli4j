...
```kotlin
dependencies {
    implementation("com.aayushatharva.brotli4j:brotli4j:1.22.0")
    runtimeOnly("com.aayushatharva.brotli4j:natives:1.22.0")
}
```
...
```kotlin
dependencies {
    shaded("com.aayushatharva.brotli4j:natives:1.22.0")
}
